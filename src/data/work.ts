...
export const works: WorkDocument = {
  id: 'work',
  title: {
    ja: '作品',
    en: 'Work',
  ...
  entries: [
    {
      ...
      description_long: {
        ...
        cn: '作为学习TypeScript和Next.js的一部分制作的作品集网站。\n源代码已在GitHub上公开。',
        tw: '作為學習TypeScript和Next.js的一部分製作的作品集網站。\n源代碼已在GitHub上公開。',
    ...
    },
    {
      ...
      name: {
        ...
        cn: 'Translate number to LanguageStrings',
        tw: 'Translate number to LanguageStrings',
      ...
      description_short: {
        ...
        cn: '将数字转换为英语、日语、中文和韩语的网站',
        tw: '將數字轉換為英文、日文、中文和韓文的網站',
    ...
    },
    {
      ...
      description_long: {
        ...
        cn: '使用Unity游戏引擎制作的简单横向卷轴游戏。\n主要目的是验证输入系统和本地化。\n游戏充满了内部梗，还存在一些小bug。\n支持日语、英语、简体中文、繁体中文、韩语和印尼语。',
        tw: '使用Unity遊戲引擎製作的簡單橫向卷軸遊戲。\n主要目的是驗證輸入系統和本地化。\n遊戲充滿了內部梗，還存在一些小bug。\n支持日語、英語、簡體中文、繁體中文、韓語和印尼語。',
    ...
    },
    {
      ...
      description_long: {
        ...
        cn: '我正在使用Unity游戏引擎制作2D RPG。\n开发规模非常大，因此完成需要很长时间。\n很抱歉，我无法展示源代码。',
        tw: '我正在使用Unity遊戲引擎製作2D RPG。\n開發規模非常大，因此完成需要很長時間。\n很抱歉，我無法展示源代碼。',
    ...
    },
    {
      ...
      description_long: {
        ...
        cn: '我正在使用Unity游戏引擎制作文字冒险游戏。\n目标是快速完成一个相对容易制作的项目。\n很抱歉，我无法展示源代码。',
        tw: '我正在使用Unity遊戲引擎製作文字冒險遊戲。\n目標是快速完成一個相對容易製作的項目。\n很抱歉，我無法展示源代碼。',
